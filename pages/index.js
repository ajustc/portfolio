          ...
          <div className='w-full md:w-6/12 md:flex md:items-center'>
            <div className='flex flex-col'>
              ...
              <p className=''>
                ...
                basic concepts of MVC in PHP programming language with the help
                of a framework like CodeIgniter or Laravel, thank u.
              </p>
                    ...
                    <div className='bg-white rounded shadow-lg w-10/12 md:w-2/3 h-2/3 md:h-3/4 overflow-y-auto'>
                      ...
                      <div className=''>
                        <div className='w-full static p-4'>
                          ...
                          curl because this technology is built with PHP Native,
